...
impl projectm {
    pub fn create(settings: &settings, flags: i32) -> *mut ffi::projectm {
    ...
    pub fn create_from_file(settings_path: &String, flags: i32) -> *mut ffi::projectm {
        return unsafe { ffi::projectm_create(settings_path.as_bytes().as_ptr() as *mut i8, flags) };
    }
    ...
    pub fn get_texture_size(instance: projectm_handle) -> usize {
        return unsafe { ffi::projectm_get_texture_size(instance) };
    }

    pub fn set_texture_size(instance: projectm_handle, size: usize) {
        unsafe { ffi::projectm_set_texture_size(instance, size) };
    }
    ...
    // pub fn get_preset_duration(instance: projectm_handle, seconds: f64) {
    //     unsafe { ffi::projectm_get_preset_duration(instance, seconds) }
    // }
    ...
    pub fn get_fps(instance: projectm_handle) -> usize {
        return unsafe { ffi::projectm_get_fps(instance) };
    }

    // !TODO Add this function
    // pub fn set_fps(instance: projectm_handle) -> usize {
    //     return unsafe { ffi::projectm_set_fps(instance) };
    // }
    ...
    pub fn select_random_preset(instance: projectm_handle, hard_cut: bool) {
        unsafe { ffi::projectm_select_random_preset(instance, hard_cut) };
    }
